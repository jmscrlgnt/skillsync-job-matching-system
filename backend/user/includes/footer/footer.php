  ...
  <div class="container">
    <div class="footer-clean-shell compact">
      <div class="footer-brand-stack">
        ...
        <p>SkillSync streamlines hiring by connecting talent with opportunities through intelligent skill-based matching.</p>
      </div>
    ...
    <div class="chatbot-header">
      <div class="chatbot-header-left">
        ...
        <div class="chatbot-title-wrap">
          <strong id="chatbotAssistantName">Job Search Assistant</strong>
