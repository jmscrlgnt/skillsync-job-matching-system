...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark app-navbar private-navbar">
  ...
  <li class="nav-item">
    <a class="nav-link <?= $currentPage === 'dashboard' ? 'active-page' : '' ?>" href="?page=dashboard">Home</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?= $currentPage === 'browse' ? 'active-page' : '' ?>" href="?page=browse">Browse Jobs</a>
  </li>
  <li class="nav-item">
    <a class="nav-link modal-nav-link" href="#" data-bs-toggle="modal" data-bs-target="#postJobModal" id="navPostJob">Post Job</a>
  </li>
  <li class="nav-item">
   <a class="nav-link modal-nav-link" href="#" data-bs-toggle="modal" data-bs-target="#manageJobModal" id="navManageJob">Manage Jobs</a>
  </li>
